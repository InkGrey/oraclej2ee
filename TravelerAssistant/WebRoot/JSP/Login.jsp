...
<link rel="stylesheet" href="../CSS/CSSforLogin/base.css" type="text/css">
 
<link rel="stylesheet" type="text/css" href="../CSS/CSSforLogin/register.css">
<title> Login</title>
s<script type="text/javascript" src="../JS/ JSforLogin/jquery-1.8.0.min.js"></script>
<style type="text/css">
	html {
		overflow: hidden;
	}
...
<hr />
 <div class='signup_container'>
    ...
    <div class="login-btn-set"><div class='rem'>记住我</div> <a href="Home.html" class='login-btn'></a></div>
    <p class='copyright'>版权所有 dxy10122510237<br/>
    <a href="JSP/Register.jsp">注册</a></p>
</div>
<div id="screen"></div>
<div id="bankImages">
