    ...
    if (typeof page_config != 'undefined' && $theme_control_panel) {
        ...
        if (page_config.patterns_liquid) {
            ...
            $.each(page_config.patterns_liquid, function(idx, val) {
                ...
                change_html_liquid += '<li><a href="../../../themeChanger/js/' + val.className + '" title="' + val.name + '" class="' + val.className + '"></a></li>';
        ...
        if (page_config.patterns_fixed) {
            ...
            $.each(page_config.patterns_fixed, function(idx, val) {
                ...
                change_html_fixed += '<li><a href="../../../themeChanger/js/' + val.className + '" title="' + val.name + '" class="' + val.className + '"></a></li>';
		...
		var setDefaultsSettings = function() {
			...
			$.cookie('bgcolor', null);
			$body.removeClass().addClass('fixed light l-pattern-1 f-pattern-1');
			$links_bg_wrapper.css('display','none');
			$layout_block_fixed.css('display','block');ss
			$layout_block_liquid.css('display','none');
